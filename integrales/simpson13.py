...
cantidad = input("ingrese cantidad de intervalos a calcular: ")
f = input("ingrese funcion: ")

calculo = Simpson13(xi, xf, cantidad, f)




print("El area calculada es de:", calculo.calculo13())
print("Con un error de:", calculo.error())
