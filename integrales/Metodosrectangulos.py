from sympy import sin, cos, tan, cot, exp, ln, re, pi, sqrt
import numpy as np
...
cantidad = input("ingrese cantidad de rectangulos a calcular: ")
f = input("ingrese funcion: ")

rectangulo=MetodoRectangulos(xi, xf, cantidad, f)
print("El resultado de la integral por la derecha es", rectangulo.derecho())
print("El resultado de la integral por la izquierda es", rectangulo.izquierdo())
print("El resultado de la integral por la central es", rectangulo.central())